...
const EXPORTS = {
    ...
    downloadReceiptPDF(booking) {
        ...
        const tableData = [
            [{ content: `${booking.venueName} 194a, 4th cross, Kalyan Nagar Chowrasta, Vengal Rao Nagar Rd, Kalyan Nagar Phase 1, Hyderabad, Telangana 500045`, colSpan: 2, styles: { textColor: [100, 100, 100], fontSize: 8, fontStyle: 'bold' } }],
